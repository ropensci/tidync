...
queries to extract arbitrary sub-arrays. 

The data extracted can be used directly as an array, or in long-form data frame.
In contrast to other packages tidync helps reduce the volume of code required to
discover and read the contents of NetCDF, with simple steps:
