...
constructing efficient queries to extract arbitrary hyperslabs. The data
extracted can be used directly as an array, or in "long form" form as a data
frame for "tidy" analysis and visualization contexts.
...
Further utilities are available to get immediate information on the current
status of the activated grid, and the subsetted space. These are directly
