...
We either have to get the whole “slab” that encompasses those 2 cells,
or request a degenerate 1-cell slab for each:
...
ultimately limited by the API to these “slab” requests, and there a of
disparate approaches across packages to optimizing this.
